function [ds, bs, trees, score_export] = gdetect(pyra, model, thresh, justselect, max_num)
...
disp('Got Model now parsing') ;
[ds, bs, trees, score_export] = gdetect_parse(model, pyra, thresh, max_num, justselect);
