function [rec,prec,ap] = evaltrackdet(delta_t,dettracks,gttracks,minoverlap,draw)
...
for t=tmin:(tmax-delta_t)
  ...
  % select dettracks passing through t1 and t2
  ind1=find(dettracks.frames==t1);
  ind2=find(dettracks.frames==t2);
