function [A, b, edge_secvelocity, Q_data, Q] = addOverlapRelaxedConstraints( xs, frids, edge_xi, edge_xj, ovthresh, nvars, nvarq, firstdets, firstedgs ) 
% function [A2, b2, param.edge_secvelocity, param.Qt_data, param.Qt] = addOverlapRelaxedConstraints( xs, frids, ovthresh ) 
