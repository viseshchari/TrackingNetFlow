function [A, b, edge_velocity, Q_data, Q] = addTemporalRelaxedConstraintsNorm( detstruct, edge_xi, edge_xj, xs, frids, velthresh, nvars, nvarq )
...
edge_velocity = ( ( ( edge_velocity(:,1)-edge_velocity(:,3) ).^2+( edge_velocity(:,2)-edge_velocity(:,4) ).^2 ) )-2  ;
